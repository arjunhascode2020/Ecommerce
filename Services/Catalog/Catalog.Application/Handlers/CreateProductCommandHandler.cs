...
namespace Catalog.Application.Handlers
{
    public class CreateProductCommandHandler : IRequestHandler<CreateProductCommand, ProductResponse>
    {
        ...
        async Task<ProductResponse> IRequestHandler<CreateProductCommand, ProductResponse>.Handle(CreateProductCommand request, CancellationToken cancellationToken)
        {
