...
namespace Catalog.Application.Handlers
{
    public class GetProductByBrandQueryHandler : IRequestHandler<GetProductByBrandQuery, IList<ProductResponse>>
    {
        ...
        async Task<IList<ProductResponse>> IRequestHandler<GetProductByBrandQuery, IList<ProductResponse>>.Handle(GetProductByBrandQuery request, CancellationToken cancellationToken)
        {
